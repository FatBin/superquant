...
public class FieldData implements FieldDataService {
	...
	public fieldStatisticPO getStatisticOfField() {
		...
		try {
			...
			fieldStatisticPO = new fieldStatisticPO(jsonArray.getString(0)
					.toString(), jsonArray.getString(1).toString(), jsonArray
					.getString(2).toString(),
					jsonArray.getString(3).toString(), jsonArray.getString(4)
							.toString(), jsonArray.getString(5).toString(),
					jsonArray.getString(6).toString(), jsonArray.getString(7)
							.toString(), jsonArray.getString(8).toString());
		} catch (Exception e) {
