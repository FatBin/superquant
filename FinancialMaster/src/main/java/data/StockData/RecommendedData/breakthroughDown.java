...
public class breakthroughDown implements Runnable{
	public final String[] url={"http://data.10jqka.com.cn/rank/xxtp/board/5/order/asc/page/","/ajax/1/"};
	public final int page=40;
	public static ArrayList<breakthroughPO> arrayList;
	
	public breakthroughDown() {
