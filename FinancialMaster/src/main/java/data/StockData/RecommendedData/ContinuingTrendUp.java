...
public class ContinuingTrendUp implements Runnable{
	public final String[] url={"http://data.10jqka.com.cn/rank/lxsz/field/lxts/order/desc/page/","/ajax/1/"};
	public final int page=20;
	public static ArrayList<ContinuingTrendPO> arrayList;
	
	public ContinuingTrendUp() {
