...
public class benchCurrentDataPO {
	...
	public benchCurrentDataPO(String status, String time, double now, double rise_fall_price, double rise_fall_percent,
			double high, double low, double open, double yesterday_close, String price, String volume,
			String rise_company, String fall_company, String company) {
		super();
		this.status = status;
		this.time = time;
		this.now = now;
